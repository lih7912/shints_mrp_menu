    ...
    useEffect(() => {
        ...
        if (tUserId === '') {
           ...
           if (window.location.href.includes('webapp')) 
              ...
              tUrl = `${window.location.protocol}//${window.location.hostname}:3201/#/login`;
           else  
              tUrl = `${window.location.protocol}//${window.location.hostname}:3201/#/login`;
...
*/
    ...
    const procVisible_extern = (idx, argUrl, argLabel) => {
        if (idx === 0) {
          setIsTabs1('show0');
          if (argUrl === "") {
            ;
...
*/
    ...
    const onExternCall = (argValue) => {
        ...
        if (_findObj0.idx >= 0) { 
          ...
          onTabChangeProgram_extern (tObj10);
          return;
        }
        ...
        if (window.location.href.includes('webapp')) 
              ...
              tUrl = `${window.location.protocol}//${window.location.hostname}:3201/#/${item.url1}`;
        else  
              tUrl = `${window.location.protocol}//${window.location.hostname}:3201/#/${item.url1}`;
    ...
    const onMenuItemClick = (argValue) => {
        ...
        console.log('onMennItem:(click menuitem)' + saveIndex2 + ',' + _retObj.idx);
    ...
    const onTabChangeProgram_extern = (argData) => {
        ...
        if (window.location.href.includes('webapp')) 
              ...
              tUrl = `${window.location.protocol}//${window.location.hostname}:3201/#/${argData.url1}`;
        else  
              tUrl = `${window.location.protocol}//${window.location.hostname}:3201/#/${argData.url1}`;

        let _url1 = tUrl;
        console.log("onTabChangeProgram(extern-2):" + _url1);
        procVisible_extern (_tOne.idx, _url1, argData.label);
        // procVisible(_retObj.idx, _url1, item.label);
...
*/
    ...
    const menu1 = [
        {
            key: '0', label: 'INFO', url1: '', icon: 'pi pi-fw pi-clone',
            children: [
                ...
                { key: '0-5', label: 'Supplier', icon: 'pi pi-fw pi-user-edit', url1: 'S0114_KCD_SUPPLIER', children: []},
        ...
        {
            key: '1', label: 'ORDER', url1: '',  icon: 'pi pi-fw pi-clone',
            children: [
                { key: '1-1', label: 'Style Regist', icon: 'pi pi-fw pi-user-edit', url1: 'S0200_KCD_STYLE' },
                { key: '1-2', label: 'Style Price', icon: 'pi pi-fw pi-user-edit', url1: 'S0202_STYLE_COST' },
        ...
        {
            key: '2', label: 'MRP', icon: 'pi pi-fw pi-clone', url1: '',
            children: [
                ...
                { key: '2-6', label: 'MRP Record(Order)', icon: 'pi pi-fw pi-user-edit', url1: 'S0307_MRP_RECORD_STYLE'}
            ]
        },
        {
            key: '3', label: 'PURCHASE', icon: 'pi pi-fw pi-clone', url1: '',
            children: [
        ...
        {
            key: '4', label: 'EXPORT/IMPORT', icon: 'pi pi-fw pi-clone', url1: '',
            children: [
                ...
                { key: '4-9', label: '(#)관세환급관리', icon: 'pi pi-fw pi-user-edit', url1: 'S0609_MANAGE_RETURN_TAX' },
        ...
        },
        {
            ...
            children: [
                ...
                { key: '5-2', label: 'Clearance_Arrival(BVT)', icon: 'pi pi-fw pi-user-edit', url1: 'S0518_FACTORY_ARRIVAL?FACTORY=BVT' },
                { key: '5-17', label: 'Clearance_Arrival(ETP)', icon: 'pi pi-fw pi-user-edit', url1: 'S0518_FACTORY_ARRIVAL?FACTORY=ETP' },
                ...
                { key: '5-12', label: 'Stock Manager', icon: 'pi pi-fw pi-user-edit', url1: 'S0523_STOCK_MANAGER' },
                { key: '5-13', label: 'Stock I/O History', icon: 'pi pi-fw pi-user-edit', url1: 'S0517_STOCK_HISTORY'},
            ]
        },
        {
            key: '6', label: 'COST', icon: 'pi pi-fw pi-clone',url1: '',
            children: [
                ...
                { key: '6-8', label: 'Sample Cost', icon: 'pi pi-fw pi-user-edit', url1: 'S0203_SAMPLE_COST' },
                { key: '6-9', label: 'CMPT Confirmation', icon: 'pi pi-fw pi-user-edit', url1: 'S0212_NEGO_CMPT'},
                { key: '6-6', label: '(#)수입자재미지급조회', icon: 'pi pi-fw pi-user-edit', url1: ''},
            ]
        },
        {
            key: '7', label: 'RECEIVABLES', icon: 'pi pi-fw pi-clone', url1: '',
            children: [
                ...
                { key: '7-5', label: 'Nego입금등록', icon: 'pi pi-fw pi-user-edit', url1: 'S0607_LC_NEGO'},
    ...
    const menu2 = [
        {
            ...
            children: [
                { key: '0-1', label: 'Bank', icon: 'pi pi-fw pi-user-edit', url1: 'S0110_KCD_BANK_QRY', children: [] },
                { key: '0-2', label: 'User', icon: 'pi pi-fw pi-user-edit', url1: 'S0111_KCD_USER', children: []},
                { key: '0-3', label: 'Size', icon: 'pi pi-fw pi-user-edit', url1: 'S0107_KCD_SIZEMST', children: []},
                { key: '0-4', label: 'Buyer', icon: 'pi pi-fw pi-user-edit', url1: 'S0113_KCD_BUYER', children: []},
                { key: '0-5', label: 'Supplier', icon: 'pi pi-fw pi-user-edit', url1: 'S0114_KCD_SUPPLIER', children: []},
                { key: '0-6', label: 'Factory', icon: 'pi pi-fw pi-user-edit', url1: 'S0101_KCD_FACTORY', children: []},
    ...
    const menu3 = [
                ...
                { key: '2-2', label: 'Material Search', icon: 'pi pi-fw pi-user-edit', url1: 'S0302_MATL_SEARCH'},
                { key: '2-3', label: 'MRP Record(Style)', icon: 'pi pi-fw pi-user-edit', url1: 'S0303_MRP_RECORD_STYLE'},
                { key: '2-20', label: 'Copy Product', icon: 'pi pi-fw pi-user-edit', url1: 'S030301_COPY_PRODUCT'},
                { key: '2-21', label: 'Copy Style', icon: 'pi pi-fw pi-user-edit', url1: 'S030302_COPY_STYLE'},
                { key: '2-22', label: 'Mrp By Search', icon: 'pi pi-fw pi-user-edit', url1: 'S030303_MRP_BY_SEARCH'},
                { key: '2-4', label: 'MRP Manager', icon: 'pi pi-fw pi-user-edit', url1: 'S0305_MRP_MANAGER'},
                { key: '2-6', label: 'Del Pack', icon: 'pi pi-fw pi-user-edit', url1: 'S030501_DEL_MRP_PACK'},
                { key: '2-7', label: 'Po History', icon: 'pi pi-fw pi-user-edit', url1: 'S030502_PO_HISTORY'},
                { key: '2-8', label: 'Stock Check', icon: 'pi pi-fw pi-user-edit', url1: 'S030503_STOCK_CHECK'},
                { key: '2-9', label: 'Revise', icon: 'pi pi-fw pi-user-edit', url1: 'S030504_REVISE'},
                { key: '2-10', label: 'Matl Add', icon: 'pi pi-fw pi-user-edit', url1: 'S030505_PO_RECORD_MATL_ADD'},
                { key: '2-11', label: 'New PO', icon: 'pi pi-fw pi-user-edit', url1: 'S030506_NEW_PO_SAMPLE'},
                { key: '2-12', label: 'Make MRP', icon: 'pi pi-fw pi-user-edit', url1: 'S030510_PO_MAKE_MRP'},
                { key: '2-13', label: 'Make MRP(F)', icon: 'pi pi-fw pi-user-edit', url1: 'S030512_PO_MAKE_MRP_FIRST'},
                { key: '2-14', label: 'PO History2', icon: 'pi pi-fw pi-user-edit', url1: 'S030511_PO_HISTORY2'},
                { key: '2-5', label: 'MRP Record(Order)', icon: 'pi pi-fw pi-user-edit', url1: 'S0306_MRP_BY_ORDER'},
                { key: '3-1', label: 'Purchase Manager', icon: 'pi pi-fw pi-user-edit', url1: 'S0401_PURCHASING_MANAGER' },
                { key: '3-10', label: 'Purchase Reg', icon: 'pi pi-fw pi-user-edit', url1: 'S040101_PURCHASER_REG' },
                { key: '3-11', label: 'Purchase Info', icon: 'pi pi-fw pi-user-edit', url1: 'S040102_PURCHASER_INFO' },
                { key: '3-2', label: 'STSIN Record', icon: 'pi pi-fw pi-user-edit', url1: 'S0430_STSIN_RECORD'},
                { key: '3-4', label: 'STSIN List', icon: 'pi pi-fw pi-user-edit', url1: 'S043001_STSIN_LIST'},
                { key: '3-5', label: 'STSOUT Record', icon: 'pi pi-fw pi-user-edit', url1: 'S0431_STSOUT_RECORD'},
                { key: '3-6', label: 'STSOUT List', icon: 'pi pi-fw pi-user-edit', url1: 'S043101_STSOUT_LIST'},
                ...
                { key: '3-8', label: 'Bill Manager', icon: 'pi pi-fw pi-user-edit', url1: 'S0423_TAXBILL'},
                { key: '4-1', label: 'Shippment Manager', icon: 'pi pi-fw pi-user-edit', url1: 'S0434_SHIPMENT_MANAGER' },
                { key: '4-10', label: 'Shippment Reg', icon: 'pi pi-fw pi-user-edit', url1: 'S0433_SHIPMENT_REGIST' },
                { key: '4-11', label: 'Shippment Info', icon: 'pi pi-fw pi-user-edit', url1: 'S043401_SHIPMENT_INFO' },
                { key: '4-12', label: 'Freight Reg', icon: 'pi pi-fw pi-user-edit', url1: 'S0440_FREIGHT_REGIST' },
                { key: '4-13', label: 'Shipping Cost', icon: 'pi pi-fw pi-user-edit', url1: 'S0435_SHIPPING_COST' },
                { key: '4-14', label: 'Local Cost', icon: 'pi pi-fw pi-user-edit', url1: 'S0436_LOCAL_COST' },
                { key: '4-15', label: 'STSIN_INFO', icon: 'pi pi-fw pi-user-edit', url1: 'S043002_STSIN_INFO' },
                { key: '4-2', label: '수출등록(국내)', icon: 'pi pi-fw pi-user-edit', url1: 'S0437_EXPORT_REGIST'},
                { key: '4-3', label: '수입등록(국내)', icon: 'pi pi-fw pi-user-edit', url1: 'S0438_IMPORT_REGIST'},
                { key: '4-8', label: 'Garment Ship', icon: 'pi pi-fw pi-user-edit', url1: 'S0513_SHIPPING_LIST'},
                { key: '4-6', label: 'Garment Invoice List(#)', icon: 'pi pi-fw pi-user-edit', url1: '#'},
                ...
                { key: '6-6', label: '(#)수입자재미지급조회', icon: 'pi pi-fw pi-user-edit', url1: ''},
                { key: '7-2', label: '매출등록(국내)', icon: 'pi pi-fw pi-user-edit', url1: 'S0801_DOCU_REGIST_DOMESTIC' },
                { key: '7-11', label: '세금계산서등록', icon: 'pi pi-fw pi-user-edit', url1: 'S080101_DOCU_REGIST_DOMESTIC' },
                { key: '7-3', label: '매출등록(해외)', icon: 'pi pi-fw pi-user-edit', url1: 'S0802_DOCU_REGIST_OVERSEA' },
                { key: '7-5', label: 'Nego입금등록', icon: 'pi pi-fw pi-user-edit', url1: 'S0607_LC_NEGO'},
                { key: '7-7', label: 'TT입금등록', icon: 'pi pi-fw pi-user-edit', url1: 'S0707_MAN_INVOICE'},
                { key: '7-6', label: '(#)입금조회', icon: 'pi pi-fw pi-user-edit', url1: 'S0608_NEGO_LIST'},
