...
export const AppMenu1 = (props) => {

    return (
        <div className="layout-menu-container">
            <AppSubmenu1 items={props.model} className="layout-menu"  onMenuItemClick={props.onMenuItemClick} root={true} role="menu" />
        </div>
    );
}
