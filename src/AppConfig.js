                ...
                <div className="grid free-themes">
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "bootstrap4-dark-purple", "dark")
                            }
                        >
                            <img
                ...
                <div className="grid free-themes">
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "md-light-indigo", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "md-light-deeppurple", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "md-dark-indigo", "dark")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "md-dark-deeppurple", "dark")
                            }
                        >
                            <img
                ...
                <div className="grid free-themes">
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "mdc-light-indigo", "light")
                            }
                        >
                            <img
                                src="assets/layout/images/themes/md-light-indigo.svg"
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "mdc-light-deeppurple", "light")
                            }
                        >
                            <img
                                src="assets/layout/images/themes/md-light-deeppurple.svg"
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "mdc-dark-indigo", "dark")
                            }
                        >
                            <img
                                src="assets/layout/images/themes/md-dark-indigo.svg"
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "mdc-dark-deeppurple", "dark")
                            }
                        >
                            <img
                                src="assets/layout/images/themes/md-dark-deeppurple.svg"
                ...
                <div className="grid free-themes">
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "tailwind-light", "light")
                            }
                        >
                            <img
                ...
                <div className="grid free-themes">
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "fluent-light", "light")
                            }
                        >
                            <img
                ...
                <div className="grid free-themes">
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "lara-light-indigo", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "lara-light-blue", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "lara-light-purple", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "lara-light-teal", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "lara-dark-indigo", "dark")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "lara-dark-blue", "dark")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "lara-dark-purple", "dark")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "lara-dark-teal", "dark")
                            }
                        >
                            <img
                ...
                <div className="grid free-themes">
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "saga-green", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "saga-orange", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "saga-purple", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "arya-orange", "dark")
                            }
                        >
                            <img
                    ...
                    <div className="col-3 text-center">
                        <button
                            className="p-link"
                            onClick={(e) =>
                                changeTheme(e, "arya-purple", "dark")
                            }
                        >
                            <img
