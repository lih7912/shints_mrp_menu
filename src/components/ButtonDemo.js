        ...
        <div className="grid">
            <div className="col-12 md:col-6">
                <div className="card">
                    ...
                    <Button
                        label="Link"
                        className="p-button-link mb-2 mr-2"
                    ></Button>
                </div>
                ...
                <div className="card">
                    ...
                    <Button
                        label="Secondary"
                        className="p-button-secondary p-button-text mr-2 mb-2"
                    />
                    <Button
                        label="Success"
                        className="p-button-success p-button-text mr-2 mb-2"
                    />
                    <Button
                        label="Info"
                        className="p-button-info p-button-text mr-2 mb-2"
                    />
                    <Button
                        label="Warning"
                    ...
                    <Button
                        label="Help"
                        className="p-button-help p-button-text mr-2 mb-2"
                    />
                    <Button
                        label="Danger"
                    ...
                    <Button
                        label="Plain"
                        className="p-button-plain p-button-text mr-2 mb-2"
                    />
                </div>
            ...
            <div className="col-12 md:col-6">
                ...
                <div className="card">
                    ...
                    <Button
                        label="Success"
                        className="p-button-raised p-button-success mr-2 mb-2"
                    />
                    <Button
                        label="Info"
                    ...
                    <Button
                        label="Danger"
                        className="p-button-raised p-button-danger mr-2 mb-2"
                    />
                </div>
                ...
                <div className="card">
                    ...
                    <Button
                        label="Secondary"
                        className="p-button-rounded p-button-secondary mr-2 mb-2"
                    />
                    <Button
                        label="Success"
                    ...
                    <Button
                        label="Warning"
                        className="p-button-rounded p-button-warning mr-2 mb-2"
                    />
                    <Button
                        label="Danger"
                ...
                <div className="card">
                    ...
                    <Button
                        icon="pi pi-bookmark"
                        className="p-button-rounded p-button-secondary p-button-text mr-2 mb-2"
                    />
                    <Button
                        icon="pi pi-search"
                    ...
                    <Button
                        icon="pi pi-bell"
                        className="p-button-rounded p-button-warning p-button-text mr-2 mb-2"
                    />
                    <Button
                        icon="pi pi-heart"
                        className="p-button-rounded p-button-help p-button-text mr-2 mb-2"
                    />
                    <Button
                        icon="pi pi-times"
                    ...
                    <Button
                        icon="pi pi-filter"
                        className="p-button-rounded p-button-plain p-button-text mr-2 mb-2"
                    />
                </div>
                ...
                <div className="card">
                    ...
                    <Button
                        icon="pi pi-search"
                        className="p-button-rounded p-button-success p-button-outlined mr-2 mb-2"
                    />
                    <Button
                        icon="pi pi-user"
                        className="p-button-rounded p-button-info p-button-outlined mr-2 mb-2"
                    />
                    <Button
                        icon="pi pi-bell"
                        className="p-button-rounded p-button-warning p-button-outlined mr-2 mb-2"
                    />
                    <Button
                        icon="pi pi-heart"
                        className="p-button-rounded p-button-help p-button-outlined mr-2 mb-2"
                    />
                    <Button
                        icon="pi pi-times"
                        className="p-button-rounded p-button-danger p-button-outlined mr-2 mb-2"
                    />
                </div>
