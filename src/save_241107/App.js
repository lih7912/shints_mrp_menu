...
*/
    ...
    const menu1 = [
        ...
        },
        {
            ...
            children: [
                ...
                { key: '1-17', label: 'Sale Matl Plan(Record)', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0216_SALES_MATL_PLAN_QRY'},
                { key: '1-18', label: 'Sale Matl Plan(List)', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0217_SALES_MATL_PLAN_LIST'}
            ]
        },
        {
        ...
        },
        {
            ...
            children: [
                { key: '4-1', label: 'Shippment Manager', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0434_SHIPMENT_MANAGER' },
                ...
                { key: '4-8', label: 'Garment Ship(BVT)', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0513_SHIPPING_LIST?FACTORY_CD=FC034'},
                { key: '4-20', label: 'Garment Ship(ETP)', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0513_SHIPPING_LIST?FACTORY_CD=FC044'},
        ...
        },
        {
            ...
            children: [
                ...
                { key: '5-3', label: 'Inspection Report', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0519_INSPECT_REPORT' },
        ...
        },
        {
            ...
            children: [
                ...
                { key: '6-5', label: 'Debit Note(F)', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0703_DEBIT_NOTE_FACTORY_BVT'},
    ...
    const menu3 = [
                ...
                { key: '3-8', label: 'Bill Manager', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0423_TAXBILL'},
                { key: '4-1', label: 'Shippment Manager', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0434_SHIPMENT_MANAGER' },
                { key: '4-10', label: 'Shippment Reg', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0433_SHIPMENT_REGIST' },
                { key: '4-11', label: 'Shippment Info', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S043401_SHIPMENT_INFO' },
                { key: '4-12', label: 'Freight Reg', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0440_FREIGHT_REGIST' },
                { key: '4-13', label: 'Shipping Cost', icon: 'pi pi-fw pi-user-edit',  width:'1365px', height:'675px', url1: 'S0435_SHIPPING_COST' },
